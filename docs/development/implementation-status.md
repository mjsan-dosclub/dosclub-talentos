...
Pending: database/environment connection, invitation delivery retry/management, trainer and coordinator invitation forms, remaining operational screens, Firebase push, verified-domain email delivery, deployment and production readiness. No fake login or seeded role switch is used. Authenticated pages and APIs are deliberately excluded from the offline cache.
