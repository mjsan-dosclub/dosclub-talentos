...
Pending: database/environment connection, invitation delivery retry/management, QR and geofence attendance, evidence review, profile editing, Firebase push, verified-domain email delivery, reports, deployment and production readiness. No fake login or seeded role switch is used. Authenticated pages and APIs are deliberately excluded from the offline cache.
