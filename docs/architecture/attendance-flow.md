...
Sources: QR, Trainer, DOS Organiser, College Confirmation. Retain source and event history after corrections.
...
Token lifetime, windows, geofence thresholds and late/partial/completed derivation remain PD-03–PD-05. Do not infer absence from a missing scan while a session remains active. Do not assume checkout implies evidence submission.
